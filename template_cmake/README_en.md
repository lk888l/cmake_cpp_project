...
│   └── my_project/              # Project-named namespace directory
│       └── main.h
...
│   └── example_lib/
├── assets/                      # Images, models, and configuration deployed to the board
├── scripts/                     # Deployment, rsync, and packaging scripts
│   └── deploy.sh
