...
| 文档 | 内容 | 适合读者 |
| --- | --- | --- |
| [architecture.md](architecture.md) | 分层结构、对象关系、初始化和刷新数据流 | 首次理解工程、架构评审 |
| [api-reference.md](api-reference.md) | `OledDisplay`、`OledCanvas`、I²C BSP 的完整接口说明 | 业务页面开发者 |
| [grayscale-and-rendering.md](grayscale-and-rendering.md) | framebuffer、坐标、字体、位图和 Bayer 伪灰度原理 | 图形效果和性能调试 |
| [linux-buildroot.md](linux-buildroot.md) | 构建、部署、命令行、I²C 接线与运行 | Linux/Buildroot 集成 |
| [mcu-porting.md](mcu-porting.md) | STM32F4、ESP32 移植步骤和资源优化 | MCU 驱动开发者 |
| [testing-and-troubleshooting.md](testing-and-troubleshooting.md) | 测试覆盖、诊断顺序和常见故障 | 测试、现场调试 |
