...
public:
    ...
    virtual I2CStatus write(const std::uint8_t* data, std::size_t length) = 0;
    virtual I2CStatus writeRead(const std::uint8_t* write_data,
...
public:
    ...
    virtual I2CDeviceResult createDevice(std::uint8_t address, std::uint32_t clock_hz) = 0;
