...
- [公共 API 参考](docs/api-reference.md)
- [灰度与渲染](docs/grayscale-and-rendering.md)
- [Linux / Buildroot 使用](docs/linux-buildroot.md)
- [STM32F4 / ESP32 移植](docs/mcu-porting.md)
- [测试与故障排查](docs/testing-and-troubleshooting.md)
