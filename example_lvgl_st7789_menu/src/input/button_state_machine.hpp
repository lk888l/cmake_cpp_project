...
public:
    ...
    [[nodiscard]] std::vector<ButtonEvent> processEdge(bool pressed,
...
private:
    ...
    [[nodiscard]] std::vector<ButtonEvent> commitEdge(bool pressed,
                                                      MonotonicTime timestamp);
    ...
    std::optional<PendingEdge> pending_edge_;
};
